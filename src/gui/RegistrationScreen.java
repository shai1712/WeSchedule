...
public class RegistrationScreen extends JFrame implements ActionListener {
	...
	private void createLeftPanel() {
		...
		ImageIcon timetableIcon = new ImageIcon("src/images/timetable_gray_124px.png");
		...
		wescheduleLabel.setFont(new Font("Arial", Font.BOLD | Font.ITALIC, 28));
	...
	private void createRightPanel() {
		...
		firstNameTF.setFont(new Font("Arial", Font.PLAIN, 14));
		...
		lastNameTF.setFont(new Font("Arial", Font.PLAIN, 14));
		...
		ImageIcon signUpIcon = new ImageIcon("src/images/registration_black_26px.png");
